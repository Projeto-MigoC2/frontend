...
class LoadingScreenSubjects extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _LoadingScreenSubjects();
}

class _LoadingScreenSubjects extends State<LoadingScreenSubjects> {
  @override
